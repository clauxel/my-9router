const visitorStorageKey = 'nine-router-analytics-visitor'
const sessionStorageKey = 'nine-router-analytics-session'
const queueStorageKey = 'nine-router-analytics-queue'
